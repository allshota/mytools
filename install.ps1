...
# Taken from https://proxy.shotaemail.com/https://stackoverflow.com/a/34559554/6537420
...
$pkgInfo = Invoke-WebRequest "https://proxy.shotaemail.com/https://registry.npmjs.org/@pnpm/exe" -UseBasicParsing
...
$archiveUrl="https://proxy.shotaemail.com/https://github.com/pnpm/pnpm/releases/download/v$version/pnpm-$platform-$architecture"
if ($platform -eq 'win') {
